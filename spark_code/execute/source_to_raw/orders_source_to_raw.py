...
from config.schemas import ORDERS_INPUT_CSV_SCHEMA
...
csv_path = "file:///opt/datasets/orders/"
checkpoint_path = "file:///opt/datasets/checkpoints/orders/"
raw_table_name = "raw.orders"

# Read data
print("========== Reading data from source ==========")
source_data_reader = SourceDataReader(spark_session=spark_session)
input_data_from_source = source_data_reader.read_data_as_stream(path=csv_path, schema=ORDERS_INPUT_CSV_SCHEMA)
